...
export default function Faqs(){
    return(
        <div class="flex flex-col md:flex-row-2 lg:flex-row justify-around mb-20 px-4">
            <div class="w-full md:w-1/2 p-4 md:p-0">
                ...
                <p class="text-gray-600">Explore our Frequently Asked Questions for quick answers on policies, claims, and 
                coverage, helping you make informed insurance decisions.</p>
                ...
                <div class="mt-10">
                    ...
                    <div>
                    <p class="text-gray-600 px-6 mt-3">In the new era of technology we look in the future with certainly and pride,
                    that's why so.</p>
                    </div>
                </div>
                <div class="mt-10">
