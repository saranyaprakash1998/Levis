...
export default function Footer(){
    return(
        <div class="bg-teal-900 ">
            <div class="flex flex-col md:flex-row-2 lg:flex-row justify-around mt-8 py-13">
            ...
            <div class="flex flex-col md:flex-row-2 lg:flex-row justify-around px-13 py-10 mt-10">
                <div>
            ...
            <div class="flex flex-col md:flex-row-2 lg:flex-row justify-between mb-15 mt-10">
                <p class="text-white px-10 py-10 text-lg">Copyright &copy; 2024 All Right Reserved.</p>

                <div class=" flex gap-4 text-white  px-13 py-12 text-2xl  ">
